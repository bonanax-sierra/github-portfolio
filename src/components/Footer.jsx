    ...
    <>
      <footer className="border-t border-gray-100 dark:border-white/5 py-8 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-sm text-gray-400 dark:text-gray-500">© 2026 Adrian Lylle Bona</p>
          <p className="text-sm text-gray-400 dark:text-gray-500 hidden sm:block">Built with React + Tailwind CSS</p>
        </div>
      </footer>
